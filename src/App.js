    ...
    return (
       ...
       <img src="thermo_icon.svg" className="App-logo" alt="logo" />
         ...
         estimate your energy usage and cost.
          ...
          <div id="graph">
            ...
            {this.state && this.state.data && new Graph(800,400, this.state.data, "#abcdef").graph()}
         		...
         		<div className="city-text">
         				...
         				<input type="text" value="Los Angeles" value={this.state.selCity} onChange={this.asyncGraph} className="city-text-input" id="city-text-field" />
         		</div>
             <label className="area-text-input col-form-label">Area of House (ft^2)</label>
         	<input type="number" value={this.state.area} className="area-text-input" id="area-text-field" />
          <div id="human">
          ...
          <span id="credits">
          Developed by Ryan Tolsma, Daniel Tan, Drew Gregory, and Griffin Kardos. Icon Credits go to Luboš Volkov.
          </span>
       </div>
    );
  }
